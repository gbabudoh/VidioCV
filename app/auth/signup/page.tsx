        ...
        >
          {isSuccess ? (
            ...
            <p className="mt-1.5 text-sm" style={{ color: "#ACBAC4" }}>
              Showcase your skills with a video profile
            </p>
          </div>
                  ...
                  styles={{
                    ...
                    option: (base, state) => ({
                      ...
                      backgroundColor: state.isSelected
                        ...
                        : "transparent",
                      color: state.isSelected ? "#57595B" : "#57595B",
                      cursor: "pointer",
                      padding: "8px 12px",
          ...
          <div className="mt-7 pt-6 text-center" style={{ borderTop: "1px solid #E8ECED" }}>
            <p className="text-sm" style={{ color: "#ACBAC4" }}>
              ...
              <Link href="/auth/login" className="font-bold transition-colors" style={{ color: "#F7B980" }}>
                Log in
              </Link>
            </p>
          </div>
